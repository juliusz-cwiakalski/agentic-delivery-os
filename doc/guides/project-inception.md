...
- **Templated here** = a template ships under `doc/templates/` (this change,
  GH-69, plus the enriched north star).
- **Reuse existing template** = an ADOS template already ships under
  `doc/templates/`.
- **Produced by @bootstrapper / CI (GH-71)** = generated by agent automation in a
  later slice; no hand-authored template today.
- **GH-33** = produced by the tribal-knowledge extraction slice.

### Always-produced (all projects)

| Artifact | Location | Template | Produced by |
|---|---|---|---|
| Inception state | `doc/inception/inception-state.yaml` | `doc/templates/inception-state-template.yaml` | Templated here (GH-69) |
| Material inventory | `doc/inception/analysis/material-inventory.md` | `doc/templates/material-inventory-template.md` | Templated here (GH-69) |
| North star | `doc/overview/01-north-star.md` | `doc/templates/north-star-template.md` | Templated here (GH-69, enriched) |
| Roadmap | `doc/overview/02-roadmap.md` | `doc/templates/roadmap-engineering-template.md` | Templated here (GH-69) |
| Tech stack | `doc/overview/tech-stack.md` | `doc/templates/tech-stack-template.md` | Templated here (GH-69) |
| Architecture overview | `doc/overview/architecture-overview.md` | `doc/templates/architecture-overview-template.md` | Templated here (GH-69) |
| Glossary | `doc/overview/glossary.md` | `doc/templates/glossary-template.md` | Templated here (GH-69) |
| AGENTS.md | project root | — | Produced by @bootstrapper (GH-71) |
| PM instructions | `.ai/agent/pm-instructions.md` | — | Produced by @bootstrapper (GH-71) |
| PR instructions | `.ai/agent/pr-instructions.md` | — | Produced by @bootstrapper (GH-71) |
| Decision instructions | `.ai/agent/decision-instructions.md` | — | Produced by @bootstrapper (GH-71) |
| Code review instructions | `.ai/agent/code-review-instructions.md` | — | Produced by @bootstrapper (GH-71) |
...
| Inception summary | `doc/inception/inception-summary.md` | `doc/templates/inception-summary-template.md` | Templated here (GH-69) |

### Conditionally-produced (based on project characteristics)

| Artifact | Location | Template | Produced by |
|---|---|---|---|
| Opportunity Solution Tree (OST) | `doc/overview/opportunity-solution-tree.md` | `doc/templates/opportunity-solution-tree-template.md` | Templated here (GH-69) |
| Personas / JTBD | `doc/overview/01-north-star.md` (section) | `doc/templates/persona-jtbd-template.md` | Templated here (GH-69) |
| Assumption register | `doc/inception/analysis/assumptions.md` | `doc/templates/assumption-register-template.md` | Templated here (GH-69) |
| Risk register | `doc/inception/analysis/risks.md` | `doc/templates/risk-register-template.md` | Templated here (GH-69) |
| User journeys | `doc/overview/user-journeys.md` | `doc/templates/user-journey-template.md` | Templated here (GH-69) |
| Screen inventory | `doc/overview/screen-inventory.md` | `doc/templates/screen-inventory-template.md` | Templated here (GH-69) |
| UX design guidance | `doc/overview/ux-guidance.md` | `doc/templates/ux-guidance-template.md` | Templated here (GH-69) |
| Ubiquitous language | `doc/overview/ubiquitous-language.md` | `doc/templates/ubiquitous-language-template.md` | Templated here (GH-69) |
| Testing strategy | `.ai/rules/testing-strategy.md` | — | Produced by @bootstrapper (GH-71) |
| CI baseline | `.github/workflows/` | — | Produced by @bootstrapper (GH-71) |
| Dev environment guide | `doc/guides/dev-setup.md` | — | Produced by @bootstrapper (GH-71) |
| NFRs | `doc/spec/nonfunctional.md` | — | Authored at inception (no template) |
| Repo analysis | `doc/inception/analysis/repo-analysis.md` | `doc/templates/repo-analysis-template.md` | Templated here (GH-69) |
| Tribal knowledge | `doc/inception/analysis/tribal-knowledge.md` | — | Produced by GH-33 |
...
| Project PRD | `doc/overview/prd.md` | `doc/templates/project-prd-template.md` | Templated here (GH-69) |
...
flowchart LR
    ...
    (per GH-52 documentation-profile.md)"]
...
- Rules files, CI workflow, dev-setup guide, and `.env.example` — produced by @bootstrapper / CI (GH-71); no hand-authored template today.
...
- `AGENTS.md`, `.ai/agent/*-instructions.md`, `doc/documentation-profile.md`, `doc/documentation-handbook.md`, `doc/templates/`, and `doc/decisions/` — produced by @bootstrapper (GH-71). The documentation profile may be authored from `doc/templates/documentation-profile-template.md`.
...
|---|---|---|
| **0** | Material scan of `doc/inception/inputs/` | Material scan + **repo ingestion** (whole-repo analysis via a large-context model). Also run **tribal-knowledge extraction** (GH-33) if PR/MR history exists. |
...
- **Tribal-knowledge graduation** (Phase 0→1): consume the `tribal-knowledge.md` from GH-33; graduate items to permanent homes (decisions, feature specs, glossary, conventions).
