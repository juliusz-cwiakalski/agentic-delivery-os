...
|-----------|------|-------|
| Depends on | Existing autonomous-delivery scripts | `deliver-ticket.sh`, `batch-deliver.sh` (the code under change); `ceo-loop.sh` (not modified — OQ-3) |
