...
# Source of truth: .opencode/agent/editor.md
...
name: editor
description: Use this agent for translation and copywriting improvements. It rewrites or   translates content to match project-specific copywriting guidelines.
model: opus
allowed-tools:
  - Read
  - Write
